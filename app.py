...
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "food-vision-305813-cd764af6e7c9.json" # change for your GCP key
PROJECT = "Food Vision" # change for your GCP project
REGION = "europe-west4" # change for your GCP region (where your model is hosted)
